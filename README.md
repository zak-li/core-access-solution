...
**Identity & Privileged Access Management (IAM/PAM) Suite**
...
You will need an authenticated `Azure CLI`, `Terraform` v1.5 or newer, and a configured `Auth0` Tenant. 

Start by copying the example variables file to `terraform.tfvars` inside the [Terraform Directory](terraform/).
